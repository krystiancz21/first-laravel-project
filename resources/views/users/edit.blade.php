...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('shop.product.edit_title', ['name' => $user->email]) }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('users.update', $user->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="city" type="text" maxlength="255"
                                           ...
                                           name="address[city]" value="{{ $user?->address?->city }}" required
                            ...
                            <div class="form-group row">
                                <label for="zip_code" class="col-md-4 col-form-label text-md-right">Kod
                                    pocztowy</label>

                                <div class="col-md-6">
                                    <input id="zip_code" type="text" maxlength="6"
                                           class="form-control @error('zip_code') is-invalid @enderror"
                                           name="address[zip_code]" value="{{ $user?->address?->zip_code }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="street" type="text" maxlength="255"
                                           ...
                                           name="address[street]" value="{{ $user?->address?->street }}" required
                            ...
                            <div class="form-group row">
                                <label for="street_no" class="col-md-4 col-form-label text-md-right">Numer
                                    ulicy</label>

                                <div class="col-md-6">
                                    <input id="street_no" type="text" maxlength="5"
                                           class="form-control @error('street_no') is-invalid @enderror"
                                           name="address[street_no]" value="{{ $user?->address?->street_no }}"
                            ...
                            <div class="form-group row">
                                <label for="home_no" class="col-md-4 col-form-label text-md-right">Numer
                                    domu</label>

...
@section('content')
    <div class="container pt-5">
        <div class="row">
            ...
            <form class="col-md-4 order-md-1 col-lg-3 sidebar-filter" id="img-url" data-img-url="{{ url('storage/') }}/" data-default-image="{{ $defaultImage }}">
                ...
                <h6 class="text-uppercase mt-5 mb-3 font-weight-bold">{{ __('shop.welcome.categories') }}</h6>

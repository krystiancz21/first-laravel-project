                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" maxlength="200" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="name" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea id="description" maxlength="600" class="form-control @error('description') is-invalid @enderror" name="description" autofocus>{{ old('description') }}</textarea>
